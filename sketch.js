...
function setup(){
  ...
  // Creating sprites
  background2 = createSprite(300,205,600,400);
  ...
  restart = createSprite(310,190,20,20);
  ...
  bheem = createSprite(120,280,30,40);
...
function draw(){
  ...
  fill("red");
  textSize(20);
  text("score = "+score,150,11);
  text("life = "+life,500,11);
...
function spawnEnemies(){
  // Creating enemies
  if (frameCount% 100 == 0){
    enemies = createSprite(550,250,30,40);
...
function spawnLadoos(){
  ...
  ladoo = createSprite(550,s,20,20);
